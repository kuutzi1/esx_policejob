Locales['fi'] = {
  ...
  ['search'] = 'tutki',
  ['hardcuff'] = 'Käsiraudat ON',
  ['handcuff'] = 'Softcuff',
  ['uncuff'] = 'Käsiraudat OFF',
  ['drag'] = 'raahaa',
  ...
  ['map_blip'] = 'Pasilan Poliisilaitos',
  ...
  ['average_offense'] = 'Ryöstöt',
  ['major_offense'] = 'Ampuma-ase Rikokset',
  ['virkamies'] = 'Virkamieheen kohdistuneet rikokset',
  ['talous'] = 'Talousrikokset',
  ['huume'] = 'Huumausaine rikokset',

  ['fine_total'] = 'sakko: %s',

  ['revive player'] = 'Kenttä Elvytys',
  ['revive_inprogress'] = 'Elvytys käynnissä',
  ['revive_complete'] = 'Elvytys onnistui',
  ['isdead'] = 'Henkilö Kuoli',
}